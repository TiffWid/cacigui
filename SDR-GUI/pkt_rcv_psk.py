...
class pkt_rcv_psk(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "pkt_rcv_psk", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("pkt_rcv_psk")
        ...
        self.sps = sps = usrp_rate/samp_rate
        ...
        self.uhd_usrp_source_0.set_center_freq(915e06, 0)
        ...
        self.digital_fll_band_edge_cc_0 = digital.fll_band_edge_cc(sps, excess_bw, 64, phase_bw)
    ...
    def set_usrp_rate(self, usrp_rate):
        ...
        self.set_sps(self.usrp_rate/self.samp_rate)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_sps(self.usrp_rate/self.samp_rate)
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 30000, 2000, window.WIN_HAMMING, 6.76))
